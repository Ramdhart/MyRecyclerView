...
import com.dicoding.myrecyclerview.CustomOnItemClickListener;
import com.dicoding.myrecyclerview.President;
    ...
    public void onBindViewHolder(CardViewViewHolder holder, int position) {
        ...
        public class CardViewViewHolder extends RecyclerView.ViewHolder {
            ...
            public CardViewViewHolder(View itemView) {
                super(itemView);
                imgPhoto = (ImageView) itemView.findViewById(R.id.img_cardview);
